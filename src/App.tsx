...
export default function App() {
  ...
  const portfolio = [
    ...
    { name: 'Textiles Barquero', logo: '/tiendahazel.png', tag: 'RETAIL · DISEÑO', desc: 'Tienda de telas especializadas y servicio premium de diseño de cortinas a medida en el sur de Costa Rica.', chips: ['Textiles', 'Diseño Custom', 'Cortinas Premium'], link: '#', cta: 'Ver Más' },
