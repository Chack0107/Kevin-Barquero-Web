...
export default function App() {
  ...
  const navItems = [
    ...
    { label: t('nav_consulting'), id: 'consulting' },
    ...
    <div className="min-h-screen bg-[#fafafa] text-[#1d1d1f] font-sans pb-20 md:pb-0">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative">
              <button
                ...
                className="flex items-center gap-1.5 text-[13px] text-[#6e6e73] hover:text-[#1d1d1f] font-medium px-3 py-1.5 rounded-full border border-gray-200 hover:border-gray-300 transition-colors"
              >
              ...
              {langOpen && (
                <div className="absolute right-0 mt-2 bg-white border border-gray-200 rounded-xl shadow-lg overflow-hidden z-50">
                  {LANGS.map(lng => (
                    <button
                      key={lng.code}
      ...
      <section id="hero" className="relative min-h-screen overflow-hidden">
        ...
        <div className="hidden lg:flex absolute right-20 bottom-0 h-full w-1/2 items-end justify-end pointer-events-none select-none">
          <img src="/kevin-hero.png" alt="Kevin Barquero" className="h-[80%] w-auto object-contain object-bottom" />
        </div>
          ...
          <div className="max-w-xl text-center lg:text-left mx-auto lg:mx-0 flex flex-col">
            <FadeSection>
              ...
              <div className="flex justify-center lg:hidden mb-6 order-2 lg:order-none">
                <img src="/kevin-hero.png" alt="Kevin Barquero" className="w-44 h-44 object-cover object-top rounded-full border-4 border-white shadow-lg" />
              </div>
              <p className="text-[11px] md:text-[12px] font-semibold tracking-widest uppercase text-[#6e6e73] mb-6 order-3 lg:order-none">{t('hero_tag')}</p>
              <p className="text-[16px] sm:text-[20px] text-[#6e6e73] leading-relaxed mb-10">{t('hero_desc')}</p>
              <div className="flex flex-col md:flex-row flex-wrap gap-3 justify-center lg:justify-start mb-12">
                <button onClick={() => goto('portfolio')} className="inline-flex items-center justify-center gap-2 bg-[#1d1d1f] text-white text-[15px] font-medium px-6 md:px-7 py-4 md:py-3.5 rounded-full hover:bg-[#333] transition-colors">
                  {t('hero_btn_portfolio')} <ArrowRight size={16} />
                </button>
          ...
          <FadeSection>
            <div className="grid lg:grid-cols-2 gap-8 md:gap-12 lg:gap-24 items-center">
              ...
              <div className="relative flex flex-col items-center">
                ...
                <img src="/kevin-photo.png" alt="Kevin Barquero" className="relative z-10 w-full max-w-[340px] lg:max-w-[400px] object-contain" />
                <div className="relative z-10 mt-4 bg-white border border-gray-100 rounded-2xl px-6 py-4 flex items-center gap-4 shadow-sm w-full max-w-[320px] lg:max-w-[360px]">
                  ...
                  <div>
                    ...
                    <p className="text-[12px] text-[#6e6e73]">{t('about_badge')}</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-6xl mx-auto px-4 md:px-6 lg:px-8">
          <FadeSection>
            <div className="text-center mb-8 md:mb-12 lg:mb-16">
              <p className="text-[11px] md:text-[12px] font-semibold tracking-widest uppercase text-[#6e6e73] mb-4">{t('consulting_tag')}</p>
              <h2 className="text-[28px] sm:text-[48px] font-bold tracking-tight leading-[1.1] text-[#1d1d1f] mb-4">{t('consulting_title')}</h2>
      ...
      <section id="portfolio" className="py-16 md:py-20 lg:py-36 bg-[#fafafa]">
        <div className="max-w-6xl mx-auto px-4 md:px-6 lg:px-8">
          <FadeSection>
            <div className="text-center mb-8 md:mb-12 lg:mb-16">
              <p className="text-[11px] md:text-[12px] font-semibold tracking-widest uppercase text-[#6e6e73] mb-4">{t('portfolio_tag')}</p>
              <h2 className="text-[28px] sm:text-[48px] font-bold tracking-tight leading-[1.1] text-[#1d1d1f] mb-4">{t('portfolio_title')}</h2>
      ...
      <section id="contact" className="py-16 md:py-20 lg:py-36 bg-[#1d1d1f] text-white">
        <div className="max-w-6xl mx-auto px-4 md:px-6 lg:px-8">
          <FadeSection>
            <div className="text-center mb-8 md:mb-12 lg:mb-16">
              <p className="text-[11px] md:text-[12px] font-semibold tracking-widest uppercase text-[#86868b] mb-4">{t('contact_tag')}</p>
              <h2 className="text-[28px] sm:text-[56px] font-bold tracking-tight leading-[1.05] mb-4">{t('contact_title')}</h2>
              <p className="text-[15px] md:text-[17px] text-[#86868b] max-w-xl mx-auto">{t('contact_subtitle')}</p>
            </div>
          </FadeSection>
      ...
      <footer className="hidden md:block py-8 bg-[#1d1d1f] border-t border-white/10">
        <div className="max-w-6xl mx-auto px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <p className="text-[13px] text-[#6e6e73]">{t('footer_copyright')}</p>
        </div>
      </footer>
        ...
        {navItems.map(n => {
          ...
          return (
            <button
              ...
              className={`flex flex-col items-center justify-center gap-1 flex-1 h-full text-[#6e6e73] hover:text-[#1d1d1f] transition-colors group ${popButton === n.id ? 'animate-button-pop' : ''}`}
            >
              {isHero ? (
